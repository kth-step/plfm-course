---
title: FDD3024 Research preparation course in programming languages and formal methods
lang: en
header-includes:
  - |
    ...
    <style type="text/css"> body { min-width: 60% !important; }</style>
---
...
- [Full definition of OCaml Light](./module-1/supplementary/ocaml-light-def.pdf), generated by [Ott](https://github.com/ott-lang/ott)
- [A Verified Type System for CakeML](https://cakeml.org/ifl15.pdf) by Tan et al.
- [CakeML project website](https://cakeml.org)
</td>
</tr>
<tr class="odd">
<td align="left">3</td>
